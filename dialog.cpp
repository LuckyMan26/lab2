    ...
    ui(new Ui::Dialog)
{
    ...
    QLabel *label3 = new QLabel("3", this);
    QLabel *label4 = new QLabel("4", this);
    QLabel *label5 = new QLabel("5", this);
    QLabel *label6 = new QLabel("6", this);
    QLabel *label7 = new QLabel("7", this);
    QLabel *label8 = new QLabel("8", this);
    QLabel *label9 = new QLabel("9", this);
    QLabel *label10 = new QLabel("10", this);
    QLabel *label11 = new QLabel("11", this);
    QLabel *label12 = new QLabel("12", this);
    QLabel *label13 = new QLabel("13", this);
    QLabel *label14 = new QLabel("14", this);
    QLabel *label15 = new QLabel("15", this);

    QGridLayout *layout = new QGridLayout;
    layout->addWidget(ui->horizontalSlider, 0, 0, 1, 15);
